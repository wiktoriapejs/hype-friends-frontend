...
export default function ItemGallery({item}){
    ...
    {
      return(
        <div className=" font-serif inset-0 absolute bg-[#E5EEEE] min-h-screen ">
          <h2 className=" fixed text-2xl left-12 top-8 flex gap-1 py-2 px-4">Photos of {item.title}</h2>
        <div className="justify-items-center p-8 grid gap-4">
          <div>
...
//  <div > className='font-serif text-[#0C6164] mt-8 bg-white m-40 border-2 px-9 py-4 border-[#0C6164]  rounded-3xl'
